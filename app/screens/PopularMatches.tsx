...
const PopularMatches = () => {
  return (
    ...
    <View style={{ flexDirection: 'row', alignItems: 'center'}}>
        <S.Title style={{ fontFamily: 'JockeyOne_400Regular', fontSize: '40px', marginRight: 20}}>Popular Matches</S.Title>
        <Ionicons name="storefront" size={35} color="#9656ce" style={{ marginTop: -38 }}></Ionicons>
    </View>
    <Text style={{ fontFamily: 'JockeyOne_400Regular', color: 'white', fontSize: '17px', marginTop: -30}}>User who receive popular amount of matches {"\n"}are featured here. Refreshed daily.</Text>
        <View style={{ flexDirection: 'row', alignItems: 'center'}}>
